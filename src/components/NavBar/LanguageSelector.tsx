  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 text-foreground text-2xl font-normal max-md:text-xl max-sm:text-lg hover:text-muted-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background rounded-sm"
      ...
      >
        ...
        <svg
          ...
          className={`dropdown-icon text-foreground transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 mt-2 bg-popover border border-border text-foreground rounded-md shadow-lg z-50 min-w-[160px]"
          role="listbox"
